...
const BUILT_IN_RULES = [
  {
    ...
    rule: 'Prefer 2/3 wrap for PTFE tape to reduce shrink-back. Use 1/2 wrap only when the target OD requires the lower single-layer build.',
  ...
  },
  {
    ...
    rule: 'When exporting MI, use the real MI-ST962-032-130.xlsx shop workbook layout and fill only the required cells such as tape part number, pitch set-point, tension, and OD after each tape/shield layer.',
