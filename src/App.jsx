...
const STEP_PATTERNS = [
  ...
  [/\b\d+\s*awg\b|\bsolid\s+(bare\s+)?(cu|copper)\b/i, { title: "Solid Cu conductor (AWG gauge)", body: "Solid copper inner conductor. AWG (American Wire Gauge): lower number = thicker wire (18 AWG ≈ 1.02 mm, 14 AWG ≈ 1.63 mm). Solid gives slightly lower RF loss than stranded (no skin-effect between strands, smoother surface). Drawback: breaks at repeated bending. Used in precision broadcast, semi-rigid, and fixed-install low-loss cables." }],
